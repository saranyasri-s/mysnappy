...
function TermsAndConditions() {
  return (
    <div className={classes.TandC}>
      ...
      <h4>Cookies</h4>
      <p>
        We employ the use of cookies. By accessing mysnappyshow, you agreed to
        use cookies in agreement with the mysnappyshow's Privacy Policy.
      </p>
      <p>
      ...
      <h4>License</h4>
      <p>
        Unless otherwise stated, mysnappyshow and/or its licensors own the
        intellectual property rights for all material on mysnappyshow. All
        intellectual property rights are reserved. You may access this from
        mysnappyshow for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>
      <p>You must not:</p>
      <ul>
        <li>Republish material from mysnappyshow</li>
        <li>Sell, rent or sub-license material from mysnappyshow</li>
        <li>Reproduce, duplicate or copy material from mysnappyshow</li>
        <li>Redistribute content from mysnappyshow</li>
      </ul>
      <p>This Agreement shall begin on the date hereof.</p>
      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        mysnappyshow does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of mysnappyshow,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, mysnappyshow shall not be
      ...
      <p>
        mysnappyshow reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant mysnappyshow a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of mysnappyshow; and (d) the link
      ...
      <p>
        ...
        e-mail to mysnappyshow. Please include your name, your organization
      ...
      <p>
        No use of mysnappyshow's logo or other artwork will be allowed for
